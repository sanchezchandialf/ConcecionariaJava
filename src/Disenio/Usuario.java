...
/**
 * Este programa representa la interacción de un usuario con el sistema de administración de vehículos.
 * Permite al usuario visualizar un catálogo de autos y motos disponibles, así como comprar vehículos.
 * Los datos de los vehículos comprados se guardan en archivos de texto ('autos_comprados.txt' y 'motos_compradas.txt')
 * para llevar un registro de las adquisiciones.
 */
